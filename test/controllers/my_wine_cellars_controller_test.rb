...
class MyWineCellarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_wine_cellar" do
    assert_difference('MyWineCellar.count') do
      post my_wine_cellars_url, params: { my_wine_cellar: { user_id: @my_wine_cellar.user_id, wineCellar_id: @my_wine_cellar.wineCellar_id } }
    end
  ...
  test "should update my_wine_cellar" do
    patch my_wine_cellar_url(@my_wine_cellar), params: { my_wine_cellar: { user_id: @my_wine_cellar.user_id, wineCellar_id: @my_wine_cellar.wineCellar_id } }
