class MyWineCellarsController < ApplicationController
  ...
  def create
    ...
    @my_wine_cellar = current_user.my_wine_cellar.create(wine_cellar: WineCellar.all.find_by(token: params[:my_wine_cellar][:token]))


    respond_to do |format|
      if @my_wine_cellar.save
        format.html { redirect_to my_wine_cellar_url(@my_wine_cellar), notice: "My wine cellar was successfully created." }
  ...
  def update
    respond_to do |format|
      if @my_wine_cellar.update(my_wine_cellar_params)
        format.html { redirect_to my_wine_cellar_url(@my_wine_cellar), notice: "My wine cellar was successfully updated." }
