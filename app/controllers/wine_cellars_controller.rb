class WineCellarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wine_cellar.save
        format.html { redirect_to wine_cellar_url(@wine_cellar), notice: "Wine cellar was successfully created." }
  ...
  def update
    respond_to do |format|
      if @wine_cellar.update(wine_cellar_params)
        format.html { redirect_to wine_cellar_url(@wine_cellar), notice: "Wine cellar was successfully updated." }
