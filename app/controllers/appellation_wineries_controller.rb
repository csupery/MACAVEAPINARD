class AppellationWineriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @appellation_winery.save
        format.html { redirect_to appellation_winery_url(@appellation_winery), notice: "Appellation winery was successfully created." }
  ...
  def update
    respond_to do |format|
      if @appellation_winery.update(appellation_winery_params)
        format.html { redirect_to appellation_winery_url(@appellation_winery), notice: "Appellation winery was successfully updated." }
  ...
  private
    ...
    def appellation_winery_params
      params.require(:appellation_winery).permit(:appellation_id, :winery_id)
    end
end
